...
namespace xmrGuiMiner
{
    class ciniAPI
    {
        ...
        public static string[] INIGetAllSectionNames(string iniFile)
        {
            ...
            uint bytesReturned = ciniAPI.GetPrivateProfileSectionNames(pReturnedString, MAX_BUFFER, iniFile);
            if (bytesReturned != 0)
            {
                //读取指定内存的内容
        ...
        public static string[] INIGetAllItems(string iniFile, string section)
        {
            ...
            uint bytesReturned = ciniAPI.GetPrivateProfileSection(section, pReturnedString, MAX_BUFFER, iniFile);
        ...
        public static string[] INIGetAllItemKeys(string iniFile, string section)
        {
            ...
            uint bytesReturned = ciniAPI.GetPrivateProfileString(section, null, null, chars, SIZE, iniFile);
        ...
        public static string INIGetStringValue(string iniFile, string section, string key, string defaultValue)
        {
            ...
            uint bytesReturned = ciniAPI.GetPrivateProfileString(section, key, defaultValue, sb, SIZE, iniFile);
        ...
        public static bool INIWriteItems(string iniFile, string section, string items)
        {
            ...
            return ciniAPI.WritePrivateProfileSection(section, items, iniFile);
        }
        ...
        public static bool INIWriteValue(string iniFile, string section, string key, string value)
        {
            ...
            return ciniAPI.WritePrivateProfileString(section, key, value, iniFile);
        ...
        public static bool INIDeleteKey(string iniFile, string section, string key)
        {
            ...
            return ciniAPI.WritePrivateProfileString(section, key, null, iniFile);
        }
        ...
        public static bool INIDeleteSection(string iniFile, string section)
        {
            ...
            return ciniAPI.WritePrivateProfileString(section, null, null, iniFile);
        }
        ...
        public static bool INIEmptySection(string iniFile, string section)
        {
            ...
            return ciniAPI.WritePrivateProfileSection(section, string.Empty, iniFile);
        }
